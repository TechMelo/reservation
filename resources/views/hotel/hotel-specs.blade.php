            ...
            <div class="row">
                <div class="col-lg-7">
                    ...
                    <div class="rt-duel-slider-thumb">
                        <div class="single--thumb rtbgprefix-cover f4" ></div><!-- /.single-thumb -->
                        <div class="single--thumb rtbgprefix-cover f4" ></div><!-- /.single-thumb -->
                        <div class="single--thumb rtbgprefix-cover f4" ></div><!-- /.single-thumb -->
                        <div class="single--thumb rtbgprefix-cover f4" ></div><!-- /.single-thumb -->
                        <div class="single--thumb rtbgprefix-cover f4" ></div><!-- /.single-thumb -->
                ...
                <div class="col-lg-5 mt-5 mt-lg-0">
                    <div class="hotel-inner-content">
                        ...
                        <p>
                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-1.png')}}" alt="hotel iamge" draggable="false"> <span class="f-size-13 rt-pl-20">Free in-room Wi-Fi</span></span>
                            <span class="d-block" ><img src="{{URL::asset('images/all-img/hottel-cion-2.png')}}" alt="hotel iamge" draggable="false"> <span class="f-size-13 rt-pl-15">Gym</span></span>
                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-3.png')}}" alt="hotel iamge" draggable="false"> <span class="f-size-13 rt-pl-25">Western restaurant</span></span>
                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-4.png')}}" alt="hotel iamge" draggable="false"> <span class="f-size-13 rt-pl-25">Front desk (24 hours)</span></span>
                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-5.png')}}" alt="hotel iamge" draggable="false"> <span class="f-size-13 rt-pl-25">soft drinks</span></span>
                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-6.png')}}" alt="hotel iamge" draggable="false"> <span class="f-size-13 rt-pl-25">Spa</span></span>
                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-9.png')}}" alt="hotel iamge" draggable="false"> <span class="f-size-13 rt-pl-25">Wake-up call</span></span>
                        </p>
                        <p class="rt-mb-30">
                            ...
                            <ul class="nav rt-tab-nav-1 pill justify-content-lg-between pl-md-4 pr-md-4 justify-content-center" id="myTab-2" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" id="rt-itm_2-tab" data-toggle="tab" href="#rt-itm_2" role="tab"
                                       aria-controls="rt-itm_2" aria-selected="true">Rooms</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link " id="rt-itm_1-tab" data-toggle="tab" href="#rt-itm_1" role="tab"
                                       aria-controls="rt-itm_1" aria-selected="false">Overview</a>
                                </li>
                                <li class="nav-item">
                        ...
                        <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tour-carosel-active owl-carousel rt-pb-100">
                                            <div class="media single-tour">
                                                <div class="icon-thumb rt-mr-23">
                                                    <img src="{{URL::asset('images/all-img/tour-1.png')}}" alt="tour image" draggable="false">
                                                </div><!-- /.icon-thumb -->
                                            ...
                                            <div class="media single-tour">
                                                <div class="icon-thumb rt-mr-23">
                                                    <img src="{{URL::asset('images/all-img/tour-2.png')}}" alt="tour image" draggable="false">
                                                </div><!-- /.icon-thumb -->
                                                <div class="media-body">
                                            ...
                                            <div class="media single-tour">
                                                <div class="icon-thumb rt-mr-23">
                                                    <img src="{{URL::asset('images/all-img/tour-3.png')}}" alt="tour image" draggable="false">
                                                </div><!-- /.icon-thumb -->
                                                <div class="media-body">
                                            ...
                                            <div class="media single-tour">
                                                <div class="icon-thumb rt-mr-23">
                                                    <img src="{{URL::asset('images/all-img/tour-4.png')}}" alt="tour image" draggable="false">
                                                </div><!-- /.icon-thumb -->
                                                <div class="media-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-5 col-lg-2 mx-auto">
                                            ...
                                            <div class="box-style__1 rt-light-bg">
                                                <div class="hote-roombgtab rtbgprefix-cover rt-mb-30" style="background-image: url(assets/images/all-img/hroom-1.jpg)"></div><!-- /.hote-room -->
                                                <h5 class="text-uppercase f-size-14 rt-medium rt-mb-15">Premier Room</h5>
                                                <p>
                                                    <span class="rt-mr-5"><img src="{{URL::asset('images/all-img/hottel-cion-10.png')}}" alt=""></span>
                                                    <span class="f-size-13 text-333">17 m²</span>
                                                </p>
                                                <p>
                                                    <span class="rt-mr-5"><img src="{{URL::asset('images/all-img/hottel-cion-11.png')}}" alt=""></span>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-6">
                                                    <ul class="rt-list d-flex flex-lg-row flex-column justify-content-md-between box-style__1 rt-light-bg rt-mb-10">
                                                        ...
                                                        <li class="rt-pt-8">
                                                                    <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-1.png')}}" alt="hotel iamge" draggable="false">
                                                                        <span class="f-size-13 rt-pl-20">Free in-room Wi-Fi</span></span>
                                                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-2.png')}}" alt="hotel iamge" draggable="false">
                                                                        <span class="f-size-13 rt-pl-15">Gym</span></span>
                                                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-3.png')}}" alt="hotel iamge" draggable="false">
                                                                        <span class="f-size-13 rt-pl-25">Western restaurant</span></span>
                                                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-4.png')}}" alt="hotel iamge" draggable="false">
                                                                        <span class="f-size-13 rt-pl-25">Front desk (24 hours)</span></span>
                                                            <span class="d-block"><img src="{{URL::asset('images/all-img/hottel-cion-5.png')}}" alt="hotel iamge" draggable="false">
                                        ...
                                        <div class="col-md-5 col-lg-2 mx-auto">
                                            ...
                                            <div class="box-style__1 rt-light-bg">
                                                <div class="hote-roombgtab rtbgprefix-cover rt-mb-30"
                                                     style="background-image: url(assets/images/all-img/hroom-1.jpg)"></div><!-- /.hote-room -->
                                                <h5 class="text-uppercase f-size-14 rt-medium rt-mb-15">Premier Room</h5>
                                                <p>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-md-6">
                                                    <ul
                                                        ...
                                                        <li class="rt-pt-8">
                                                            <span class="d-block"><img src="assets/images/all-img/hottel-cion-1.png" alt="hotel iamge"
                                                                                       draggable="false">
                                                                <span class="f-size-13 rt-pl-20">Free in-room Wi-Fi</span></span>
                                                            <span class="d-block"><img src="assets/images/all-img/hottel-cion-2.png" alt="hotel iamge"
                                                                                       draggable="false">
                                                                <span class="f-size-13 rt-pl-15">Gym</span></span>
                                                            <span class="d-block"><img src="assets/images/all-img/hottel-cion-3.png" alt="hotel iamge"
                                                                                       draggable="false">
                                                                <span class="f-size-13 rt-pl-25">Western restaurant</span></span>
                                                            <span class="d-block"><img src="assets/images/all-img/hottel-cion-4.png" alt="hotel iamge"
                                                                                       draggable="false">
                                                                <span class="f-size-13 rt-pl-25">Front desk (24 hours)</span></span>
                                                            <span class="d-block"><img src="assets/images/all-img/hottel-cion-5.png" alt="hotel iamge"
                                                                                       draggable="false">
                                                                <span class="f-size-13 rt-pl-25">soft drinks</span></span>
                                                        </li>
                                                        <li class="rt-pt-8">
                            ...
                            <div class="tab-pane fade" id="rt-itm_4" role="tabpanel" aria-labelledby="rt-itm_4-tab">
                                ...
                                <div class="flight-list-box">
                                    ...
                                    <div class="media service-amitence-box rt-mb-30">
                                        <img src="{{URL::asset('images/all-img/hottel-cion-12.png')}}" class="rt-pr-23" alt="hottel-cion">
                                    ...
                                    <div class="media service-amitence-box rt-mb-30">
                                        <img src="{{URL::asset('images/all-img/hottel-cion-13.png')}}" class="rt-pr-23" alt="hottel-cion">
                                        <div class="media-body rt-pl-23">
                                    ...
                                    <div class="media service-amitence-box rt-mb-30">
                                        <img src="{{URL::asset('images/all-img/hottel-cion-15.png')}}" class="rt-pr-23" alt="hottel-cion">
                                        <div class="media-body rt-pl-23">
                                    ...
                                    <div class="media service-amitence-box rt-mb-30">
                                        <img src="{{URL::asset('images/all-img/hottel-cion-14.png')}}" class="rt-pr-23" alt="hottel-cion">
                                        <div class="media-body rt-pl-23">
                            ...
                            <div class="tab-pane fade" id="rt-itm_5" role="tabpanel" aria-labelledby="rt-itm_5-tab">
                                <div class="flight-list-box rt-mb-30">
                                    ...
                                    <div class="media service-amitence-box rt-mb-30">
                                        <img src="{{URL::asset('images/all-img/hottel-cion-16.png')}}" class="rt-pr-23" alt="hottel-cion">
                                        <div class="media-body rt-pl-23">
                                    ...
                                    <div class="media service-amitence-box rt-mb-30">
                                        <img src="{{URL::asset('images/all-img/hottel-cion-17.png')}}" class="rt-pr-23" alt="hottel-cion">
                                        <div class="media-body rt-pl-23">
