...
@section('top-m')
    ...
    <ul class="text-center text-md-left top-message ">
        ...
        <li style="color:white !important;"><a href="mailto:info@emigrar.com "><i class="icofont-email text-white"></i>info@emigrar.com</a></li>
    </ul>
    </div>
    @endsection
@section('content')

<div id="rt-breadcump" class="rt-breadcump rt-breadcump-height with-logn-height">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-10 mx-auto ">
                    <button class="btn-tog  btn-tog-back " ><i class="fas fa-angle-double-up"></i></button>
                    <button class=" btn-tog btn-tog-down" ><i class="fas fa-angle-double-down"></i></button>

                    <div id="bottom-bar" class="bottom-bar b-bar">
...
{{--                                           </select>--}}
                                           <span class="input-iconbadge"><img
                                                   src="{{URL::asset('images/icons-image/s_icon_1.png')}}" alt=""
...
{{--                                           </select>--}}
                                           <span class="input-iconbadge"><img
                                                   src="{{URL::asset('images/icons-image/s_icon_2.png')}}" alt=""
                                                   draggable="false"></span>
                                       </div><!-- /.single-input -->
                                       <div class="single-input  col-rt-in-3">
...
{{--        <div class="row">--}}
{{--        </div>--}}
        <div class="row sort-menu-desktop">
...
{{--        <div class="row sort-menu-mobile">--}}
{{--            <div class="col-6">--}}
{{--                   <a href=".filtercoll" class=""  data-toggle="collapse" role="button" aria-expanded="false" aria-controls="collapseExample">--}}
{{--                       <h5>Filter  <i class="fas fa-sort"></i></h5></a></div>--}}
...
{{--                            <span class="d-block">Roundtrip</span>--}}
        ...
        <div class="col-lg-12 col-md-6">
            <div class="flight-list-box rt-mb-30">
                <div
                    class="top-content d-flex flex-lg-row flex-column align-items-lg-center justify-content-left  justify-content-lg-between">
                    <div class="flight-logo">
                        <img src="{{URL::asset('images/all-img/flt-logo-2.png')}}" alt="flt logo" draggable="false">
                    </div><!-- /.flight-logo -->
                    <div class="pricing">
                        <h5>Scoot</h5>
                        <p>TR978 | Airbus A320-212</p>
            ...
            <div class="flight-list-box rt-mb-30">
                <div
                    ...
                    <div class="flight-time d-flex justify-content-between align-items-lg-center">
                        ...
                        <div class="middle">
                            <img src="{{URL::asset('images/all-img/time-shape-line.pn')}}g" alt="time shape" draggable="false">
                        </div><!-- /.middle -->
                        <div class="right">
                            <span class="d-block">15.00</span>
                            <span class="d-block">SIN T2</span>
    ...
    <div class="tab-pane {{$page=='hotel'?"show active":"rtIncative"}} fade-in-bottom" id="rt-item_b_second" role="tabpanel" aria-labelledby="rt-item_b_second">
        <div class="row">
            <div class="col-xl-3 mx-auto col-lg-3 col-md-12" >
                <div class="rt-sidebar-group filtercoll" >
        ...
        <ul>
            ...
            <div class="col-xl-9 col-lg-9 mt-5 mt-lg-0">
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f37" ></div>
                        </div><!-- /.hotel-thumb -->
                        <div class="hotel-text col-md-9">
                            ...
                            <div class="footer-elements d-flex justify-content-md-between align-items-center">
                                <div class="left">
                                    <span data-tippy="wifi"><img src="{{URL::asset('images/all-img/hottel-cion-1.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="dumble"><img src="{{URL::asset('images/all-img/hottel-cion-2.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="resturent"><img src="{{URL::asset('images/all-img/hottel-cion-3.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="sofa"><img src="{{URL::asset('images/all-img/hottel-cion-4.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="watter"><img src="{{URL::asset('images/all-img/hottel-cion-5.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="music"><img src="{{URL::asset('images/all-img/hottel-cion-6.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="crolstve"><img src="{{URL::asset('images/all-img/hottel-cion-7.pn')}}g" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="doller"><img src="{{URL::asset('images/all-img/hottel-cion-8.png')}}" alt="hotel iamge"  draggable="false"></span>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f38" >
                        ...
                        <div class="hotel-text col-md-9">
                            ...
                            <div class="footer-elements d-flex justify-content-md-between align-items-center">
                                <div class="left">
                                    <span data-tippy="wifi"><img src="{{URL::asset('images/all-img/hottel-cion-2.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="resturent"><img src="{{URL::asset('images/all-img/hottel-cion-3.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="sofa"><img src="{{URL::asset('images/all-img/hottel-cion-4.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="watter"><img src="{{URL::asset('images/all-img/hottel-cion-5.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="music"><img src="{{URL::asset('images/all-img/hottel-cion-6.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="crolstve"><img src="{{URL::asset('images/all-img/hottel-cion-7.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="doller"><img src="{{URL::asset('images/all-img/hottel-cion-8.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="time"><img src="{{URL::asset('images/all-img/hottel-cion-9.png')}}" alt="hotel iamge"  draggable="false"></span>
                                </div><!-- /.left -->
                                <div class="right">
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f39 " >
                                <div class="inner-icon">
                                    <i class="icofont-gift"></i>
                                </div><!-- /.inner-icon -->
                            </div>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f40">
                                <div class="inner-icon">
                                    <i class="icofont-gift"></i>
                                </div><!-- /.inner-icon -->
                            </div>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f41" >
                                <div class="inner-icon">
                                    <i class="icofont-gift"></i>
                                </div><!-- /.inner-icon -->
                            </div>
                        ...
                        <div class="hotel-text col-md-9">
                            ...
                            <div class="footer-elements d-flex justify-content-md-between align-items-center">
                                <div class="left">
                                    ...
                                    <span data-tippy="dumble"><img src="{{URL::asset('images/all-img/hottel-cion-2.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="resturent"><img src="{{URL::asset('images/all-img/hottel-cion-3.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="sofa"><img src="{{URL::asset('images/all-img/hottel-cion-4.pn')}}g" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="watter"><img src="{{URL::asset('images/all-img/hottel-cion-5.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="music"><img src="{{URL::asset('images/all-img/hottel-cion-6.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="crolstve"><img src="{{URL::asset('images/all-img/hottel-cion-7.png')}}" alt="hotel iamge"  draggable="false"></span>
                                    <span data-tippy="doller"><img src="{{URL::asset('images/all-img/hottel-cion-8.png')}}" alt="hotel iamge"  draggable="false"></span>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f42"></div>
                        </div><!-- /.hotel-thumb -->
                        <div class="hotel-text col-md-9">
                            <div class="top mb-4 mb-md-0">
                                <h5>The Royal Pacific Hotel and Towers <span> <i class="icofont-star review"></i><i class="icofont-star review"></i> <i class="icofont-star review"></i><i class="icofont-star review"></i> <i class="icofont-star"></i></span></h5>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f43" >
                                <div class="inner-icon">
                                    <i class="icofont-gift"></i>
                                </div><!-- /.inner-icon -->
                            </div>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f44">
                                <div class="inner-icon">
                                    <i class="icofont-gift"></i>
                                </div><!-- /.inner-icon -->
                                </div>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f45" ></div>
                        </div><!-- /.hotel-thumb -->
                        <div class="hotel-text col-md-9">
                            <div class="top mb-4 mb-md-0">
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f46" ></div>
                        </div><!-- /.hotel-thumb -->
                        <div class="hotel-text col-md-9">
                            <div class="top mb-4 mb-md-0">
                                <h5>The Royal Pacific Hotel and Towers <span> <i class="icofont-star review"></i><i class="icofont-star review"></i> <i class="icofont-star review"></i><i class="icofont-star review"></i> <i class="icofont-star"></i></span></h5>
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f47"></div>
                        </div><!-- /.hotel-thumb -->
                        <div class="hotel-text col-md-9">
                            <div class="top mb-4 mb-md-0">
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f48" ></div>
                        </div><!-- /.hotel-thumb -->
                        <div class="hotel-text col-md-9">
                            <div class="top mb-4 mb-md-0">
                ...
                <div class="box-style__1 rt-mb-30">
                    <div class="hotel-inner-content row">
                        <div class="hotel-thumb col-md-3 mb-4 mb-md-0">
                           <div class="hotel-bg rtbgprefix-cover f49" >
                                <div class="inner-icon">
                                    <i class="icofont-gift"></i>
                                </div><!-- /.inner-icon -->
                            </div>
    ...
    <div class="tab-pane {{$page=='car'?"show active":"rtIncative"}} fade-in-bottom" id="rt-item_b_thrid" role="tabpanel" aria-labelledby="rt-item_b_thrid">
        <div class="row">
            <div class="col-lg-3 mx-auto col-md-12 mb-5 mb-lg-0">
                <div class="rt-sidebar-group filtercoll">
    <div class="rt-widget widget_rating">
        <h3 class="rt-widget-title">
            Star Rating
    ...
    <div class="rt-widget widget_plane_time">
        ...
        <div class="flight-list-box rt-mb-30">
            <div class="top-content d-flex flex-md-row flex-column justify-content-lg-between">
                <div class="car-thumb mr-4 mr-lg-0 mb-5 mb-md-0">
                    <img src="{{URL::asset('images/all-img/car-1.png')}}" alt="car image" class="rt-border-primary2">
                </div><!-- /.car-thumb -->
        ...
        <div class="flight-list-box rt-mb-30">
            <div class="top-content d-flex flex-md-row flex-column justify-content-lg-between">
                <div class="car-thumb mr-4 mr-lg-0 mb-5 mb-md-0">
                    <img src="{{URL::asset('images/all-img/car-2.png')}}" alt="car image" class="rt-border-primary2">
                </div><!-- /.car-thumb -->
                <div class="economy mb-5 mb-md-0">
                    <h5 class="f-size-16 rt-medium">Economy</h5>
                    <span class="d-block f-size-13 text-555">Hyundai i10 or Similar</span>
        ...
        <div class="flight-list-box rt-mb-30">
            <div class="top-content d-flex flex-md-row flex-column justify-content-lg-between">
                <div class="car-thumb mr-4 mr-lg-0 mb-5 mb-md-0">
                    <img src="{{URL::asset('images/all-img/car-3.png')}}" alt="car image" class="rt-border-primary2">
                </div><!-- /.car-thumb -->
                <div class="economy mb-5 mb-md-0">
                    <h5 class="f-size-16 rt-medium">Economy</h5>
                    <span class="d-block f-size-13 text-555">Hyundai i10 or Similar</span>
        ...
        <div class="flight-list-box rt-mb-30">
            <div class="top-content d-flex flex-md-row flex-column justify-content-lg-between">
                <div class="car-thumb mr-4 mr-lg-0 mb-5 mb-md-0">
                    <img src="{{URL::asset('images/all-img/car-4.png')}}" alt="car image" class="rt-border-primary2">
                </div><!-- /.car-thumb -->
                <div class="economy mb-5 mb-md-0">
                    <h5 class="f-size-16 rt-medium">Economy</h5>
                    <span class="d-block f-size-13 text-555">Hyundai i10 or Similar</span>
        ...
        <div class="flight-list-box rt-mb-30">
            <div class="top-content d-flex flex-md-row flex-column justify-content-lg-between">
                <div class="car-thumb mr-4 mr-lg-0 mb-5 mb-md-0">
                    <img src="{{URL::asset('images/all-img/car-5.png')}}" alt="car image" class="rt-border-primary2">
                </div><!-- /.car-thumb -->
                <div class="economy mb-5 mb-md-0">
                    <h5 class="f-size-16 rt-medium">Economy</h5>
                    <span class="d-block f-size-13 text-555">Hyundai i10 or Similar</span>
        ...
        <div class="flight-list-box rt-mb-30">
            <div class="top-content d-flex flex-md-row flex-column justify-content-lg-between">
                <div class="car-thumb mr-4 mr-lg-0 mb-5 mb-md-0">
                    <img src="{{URL::asset('images/all-img/car-6.png')}}" alt="car image" class="rt-border-primary2">
                </div><!-- /.car-thumb -->
                <div class="economy mb-5 mb-md-0">
                    <h5 class="f-size-16 rt-medium">Economy</h5>
                    <span class="d-block f-size-13 text-555">Hyundai i10 or Similar</span>
    ...
    <div class="tab-pane {{$page=='transfer'?"show active":"rtIncative"}} fade-in-bottom" id="rt-item_b_four" role="tabpanel" aria-labelledby="rt-item_b_four">
        <div class="row">
            <div class="col-lg-3 mx-auto mb-5 mb-lg-0 col-md-12">
                <div class="rt-sidebar-group filtercoll">
    <div class="rt-widget widget_range-slider">
        <h3 class="rt-widget-title">
            Filter by Price
