...
<div class="rt-preloder">
    ...
    <div class="container">
        ...
        <div class="main-header rt-sticky">
            <nav class="navbar">
                <div class="container">
                    <a href="index.html" class="brand-logo"><img src="{{URL::asset('images/logo/logo-white.png')}}" alt=""></a>
...
<section class="rt-site-footer" data-scrollax-parent="true">
    <div class="rt-shape-emenetns-1 f50"  data-scrollax="properties: { translateY: '340px' }"></div><!-- /.rt-shape-emenetns-1 -->
    <div class="footer-top rtbgprefix-cover f51">
